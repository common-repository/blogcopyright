...
function bte_bc_get_html() {
	...
	if ($bte_bc_html_tag=="div"){$cr_start.="<div "; $cr_end="</div>";}
	if ($bte_bc_html_tag=="p"){$cr_start.="<p ";  $cr_end="</p>";}
	if ($bte_bc_html_tag=="span"){$cr_start.="<span "; $cr_end="</span>";}
	$cr_start.="style='font-style:none; font-weight:normal; font-size:9pt; line-height:1.5em; font-family:Arial,Helvetica,sans-serif; display: block;' ";
	...
	$link = 'Created by <a href="http://www.blogtrafficexchange.com/" target="_blank">Blog Copyright</a>.<br><br>';
